...
![Confusion Matrix of SVM](https://github.com/Cocii/CMLS_HW1/blob/master/images/MatrixSVM_non_opt.png){:height="100px" width="400px"}


![Confusion Matrix of DNN model](https://github.com/Cocii/CMLS_HW1/blob/master/images/confusionMatrix_DNN_0.25.png){:height="100px" width="400px"}
